...
public interface SFDCSConfigService {
	...
	public Map<String, Object> updateShopFloorID(String sfdsId, String lineName,String inActive, String timeZone, Integer sfdsKey);
